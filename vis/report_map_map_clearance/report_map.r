...
results <- read.csv(file.path(folder, 'data_inputs', 'national_market_results_technology_options.csv'))
...
gdp <- read.csv(file.path(folder, 'data_inputs', 'gdp.csv'))
...
#get data
data <- read.csv(file.path(folder, 'data_inputs', 'gdp_perc_results.csv'), stringsAsFactors = F)
