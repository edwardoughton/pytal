...
if __name__ == '__main__':
    ...
    countries = [
        {'iso3': 'UGA', 'iso2': 'UG', 'regional_level': 2, 'regional_nodes_level': 2,
            'region': 'SSA', 'pop_density_km2': 500, 'settlement_size': 1000, 'subs_growth': 1,
        },
        ...
        {'iso3': 'SEN', 'iso2': 'SN', 'regional_level': 2, 'regional_nodes_level': 2,
            'region': 'SSA', 'pop_density_km2': 200, 'settlement_size': 1000, 'subs_growth': 1,
        },
        {'iso3': 'PAK', 'iso2': 'PK', 'regional_level': 3, 'regional_nodes_level': 2,
            'region': 'S&SE Asia', 'pop_density_km2': 500, 'settlement_size': 1000, 'subs_growth': 1,
        },
        {'iso3': 'ALB', 'iso2': 'AL', 'regional_level': 2, 'regional_nodes_level': 2,
            'region': 'Europe', 'pop_density_km2': 500, 'settlement_size': 1000, 'subs_growth': 1,
        },
        {'iso3': 'PER', 'iso2': 'PE', 'regional_level': 2, 'regional_nodes_level': 1,
            'region': 'LAC', 'pop_density_km2': 500, 'settlement_size': 1000, 'subs_growth': 1,
        },
