import pytest
from pytal.costs import greenfield_4g, upgrade_to_4g

    # baseline_new_site, baseline_upgrade, passive_new_site, active_new_site,
...
def test_greenfield_4g(setup_region, setup_option, setup_costs,
    ...
    total_cost, cost_structure = greenfield_4g('MWI', setup_region[0],
        setup_option['strategy'], setup_costs, setup_global_parameters,
